...
class UnitHistoryTest(unittest.TestCase):
    ...
    def test_generated_report_is_layout_first_and_omits_listing_identifiers(self):
        ...
        self.assertNotIn('id="inventory-chart"', report)
        self.assertNotIn("flat trends still draw lines and markers", report)
        ...
        self.assertIn("Stale-data warning", report)
        self.assertIn("Snapshot age:", report)
        self.assertIn("Complete-history day count:", report)
        self.assertIn("Collector health:", report)
        self.assertIn("Confidence: verified", report)
        ...
        self.assertIn("class':'chart-tooltip'", report)
        self.assertNotIn("tooltip=make('title'", report)
